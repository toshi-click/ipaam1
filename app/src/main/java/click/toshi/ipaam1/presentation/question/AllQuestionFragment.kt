...
import click.toshi.ipaam1.databinding.FragmentAllQuestionsBinding
...
//        sessionAlarm.toggleRegister(session)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = FragmentAllQuestionsBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//        }
    ...
    companion object {
        fun newInstance(): AllQuestionFragment = AllQuestionFragment()
    }
}
